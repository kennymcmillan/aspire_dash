    ...
    return html.Div([
        ...
        example("Under budget",
                 variance_card(label="Travel",
                                actual=85_000, target=100_000,
                                higher_is_better=False),
                 "variance_card('Travel', actual=85_000, target=100_000,\n"
                 "               higher_is_better=False)\n"
                 "# 'lower spend = better' for expense lines"),
        example("Over budget",
                 variance_card(label="Equipment",
                                actual=125_000, target=100_000,
                                higher_is_better=False),
                 "variance_card('Equipment', actual=125_000, target=100_000)"),

        section("utilisation_card",
                 "Spend vs budget with progress bar."),
        example("Mid-year",
                 utilisation_card(label="Operations",
                                   used=540_000, total=1_200_000),
                 "utilisation_card('Operations', used=540_000, total=1_200_000)"),
